...
class PerfilViewSet(viewsets.ModelViewSet):
	...
	serialiazer_class = PerfilSerializer
...
@api_view(['POST'])
@renderer_classes((JSONRenderer, BrowsableAPIRenderer))
def convidar(request, *arg, **kwargs):
	try:
	...
	if perfil_a_convidar != perfil_logado:
		...
		return response.Response({
				'mensagem': f'Convite enviado com sucesso para{perfil_a_convidar.email}.'}, status=status.HTTP_201_CREATED)
